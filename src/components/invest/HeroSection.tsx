...
export const HeroSection = () => {
  return (
    <section className="relative min-h-[50vh] w-full overflow-hidden sm:min-h-[70vh] md:min-h-[80vh]">
      {/* Background image */}
      <Image
       src={`${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/assets/investBG.png`}
        alt="Film investment background"
        fill
      ...
      <div className="relative z-10 flex min-h-[50vh] flex-col justify-center px-6 py-12 sm:min-h-[70vh] sm:max-w-2xl sm:px-12 sm:py-16 md:min-h-[80vh] md:px-16 lg:max-w-3xl lg:px-24">
        ...
        >
          ...
          <span className="block">
            <span className="text-[#A80A08]">FUTURE</span> OF CINEMA.
          </span>
        </h1>
        ...
        >
          Videomentum is redefining how content is distributed, monetised, and
          experienced. We're growing fast — and we're looking for partners who
          see what we see.
        </p>
      </div>
    </section>
