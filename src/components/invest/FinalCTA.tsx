      ...
      <div className="px-6 flex w-full flex-col items-center justify-between gap-8 sm:flex-row sm:gap-12">
        ...
        >
          ...
          <span className="block">
            BUILD WITH US.{" "}
            <span className="text-[#A80B09]">GROW</span> WITH US.
          </span>
        </h2>
        <p
          className="max-w-xl font-figtree text-base font-medium leading-6 tracking-[-0.31px] text-[#99999999]"
        >
         {` Whether you're an angel investor, a studio looking to co-distribute,
          or a fund exploring emerging media — we want to hear from you. Reach
